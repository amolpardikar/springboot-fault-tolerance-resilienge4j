package com.example.demo.fault.tolerance.controller;
...
public class BulkheadController {
    ...
    // Using Bulkhead, we can limit the number of concurrent requests within a particular period.
    
    @GetMapping("/getMessageBulk")
